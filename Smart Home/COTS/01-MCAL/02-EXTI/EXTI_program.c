...
/* define functions needed for set call back */
void (*LOC_PtrFunCBINT0)(void);
void (*LOC_PtrFunCBINT1)(void);
void (*LOC_PtrFunCBINT2)(void);

/* function that intialize external interrupt */
...
/* function that set call back funtions using externak=l interrupt */
...
/* function that call when using interrupt pin0 */
ISR(INT0_Vect)
{
    (*LOC_PtrFunCBINT0)();
}
/* function that call when using interrupt pin1 */
ISR(INT1_Vect)
{
    (*LOC_PtrFunCBINT1)();
}
/* function that call when using interrupt pin2 */
ISR(INT2_Vect)
{
    (*LOC_PtrFunCBINT2)(); 
}
